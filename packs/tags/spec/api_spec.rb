...
RSpec.describe Tags::Api do
  ...
  describe "#add_tagable and #chip_for" do
    it "reflects in chips the amount of times a tag has been registered" do
      ...
      add_result = Tags::Api.add_tagable(name: "XX", path: "source_path", title: "Source Title", date: "2022-01-01")
    ...
    it "add_tagable returns an error if the given tag is unacceptable" do
      add_result = Tags::Api.add_tagable(name: "", path: "", title: "", date: "alk")
