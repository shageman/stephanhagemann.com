...
# source://packwerk-extensions//lib/packwerk/folder_visibility/package.rb#5
module Packwerk::FolderVisibility; end

# source://packwerk-extensions//lib/packwerk/folder_visibility/checker.rb#9
class Packwerk::FolderVisibility::Checker
  include ::Packwerk::Checker

  # source://packwerk-extensions//lib/packwerk/folder_visibility/checker.rb#25
  sig { override.params(reference: ::Packwerk::Reference).returns(T::Boolean) }
  def invalid_reference?(reference); end

  # source://packwerk-extensions//lib/packwerk/folder_visibility/checker.rb#59
  sig { override.params(reference: ::Packwerk::Reference).returns(::String) }
  def message(reference); end

  # source://packwerk-extensions//lib/packwerk/folder_visibility/checker.rb#49
  sig { override.params(listed_offense: ::Packwerk::ReferenceOffense).returns(T::Boolean) }
  def strict_mode_violation?(listed_offense); end

  # source://packwerk-extensions//lib/packwerk/folder_visibility/checker.rb#16
  sig { override.returns(::String) }
  def violation_type; end

  private

  # source://packwerk-extensions//lib/packwerk/folder_visibility/checker.rb#78
  ...
  # source://packwerk-extensions//lib/packwerk/folder_visibility/checker.rb#83
  sig { params(reference: ::Packwerk::Reference).returns(::String) }
  def standard_help_message(reference); end
end

# source://packwerk-extensions//lib/packwerk/folder_visibility/checker.rb#13
Packwerk::FolderVisibility::Checker::VIOLATION_TYPE = T.let(T.unsafe(nil), String)

# source://packwerk-extensions//lib/packwerk/folder_visibility/package.rb#6
class Packwerk::FolderVisibility::Package < ::T::Struct
  const :enforce_folder_visibility, T.nilable(T.any(::String, T::Boolean))

  class << self
    # source://packwerk-extensions//lib/packwerk/folder_visibility/package.rb#15
    sig { params(package: ::Packwerk::Package).returns(::Packwerk::FolderVisibility::Package) }
...
# source://packwerk-extensions//lib/packwerk/folder_visibility/validator.rb#6
class Packwerk::FolderVisibility::Validator
  include ::Packwerk::Validator

  # source://packwerk-extensions//lib/packwerk/folder_visibility/validator.rb#13
  sig do
    override
      .params(
        package_set: Packwerk::PackageSet,
  ...
  # source://packwerk-extensions//lib/packwerk/folder_visibility/validator.rb#31
  sig { override.returns(T::Array[::String]) }
  def permitted_keys; end
end

# source://packwerk-extensions//lib/packwerk/folder_visibility/validator.rb#10
Packwerk::FolderVisibility::Validator::Result = Packwerk::Validator::Result
