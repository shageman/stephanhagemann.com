...
module Packs::Private
  class << self
    ...
    # source://packs//lib/packs/private.rb#526
    sig { void }
    def bust_cache!; end
    ...
    def create_pack!(pack_name:, enforce_dependencies:, enforce_privacy:, enforce_architecture:, team:); end

    # source://packs//lib/packs/private.rb#473
    sig do
      params(
        pack_name: ::String,
        enforce_dependencies: T.nilable(T::Boolean),
    ...
    def create_pack_if_not_exists!(pack_name:, enforce_dependencies:, enforce_privacy:, enforce_architecture:, team: T.unsafe(nil)); end

    # source://packs//lib/packs/private.rb#551
    sig do
      params(
    ...
    #
    # source://packs//lib/packs/private.rb#776
    sig { params(code: T::Boolean).void }
    def exit_with(code); end

    # source://packs//lib/packs/private.rb#603
    sig do
      params(
    ...
    # source://packs//lib/packs/private.rb#534
    ...
    # source://packs//lib/packs/private.rb#693
    sig { void }
    def lint_package_todo_yml_files!; end

    # source://packs//lib/packs/private.rb#728
    sig { params(packs: T::Array[::Packs::Pack]).void }
    def lint_package_yml_files!(packs); end

    # source://packs//lib/packs/private.rb#516
    sig { void }
...
# source://packs//lib/packs/private.rb#546
...
module Packs::UserEventLogger
  ...
  # source://packs//lib/packs/user_event_logger.rb#171
  ...
  # source://packs//lib/packs/user_event_logger.rb#192
  sig { returns(::String) }
  ...
  # source://packs//lib/packs/user_event_logger.rb#150
  sig { params(pack_name: ::String).returns(::String) }
